...
<br>
<br>
  <form class="form-signin" method="post" action="catracasaidaserver.php">
<h4> Obrigado pela visita ao</h4><h3>E-Parking</h3><br>

<img class="mb-4" src="img/icone.png" alt="" width="72" height="72">
<h6> Para prosseguir insira o seu PIN.</h6><br>
    <div class="form-group">
      <label><b>PIN</b></label>
      <input type="number" class="form-control" name="pname" autocomplete="off" required>
    </div>
    <button type="submit" class="btn btn-lg btn-primary btn-block" name="reg_p">Sair</button>
  </form>
