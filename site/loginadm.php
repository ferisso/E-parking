...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <form class="form-signin" method="post" action="loginadm.php">
    <?php include('errors.php'); ?>
  <img class="mb-4" src="img/icone.png" alt="" width="72" height="72">
  <h1 class="h3 mb-3 font-weight-normal">Faça seu login como Administrador</h1>
		<h6>Logar como <a href="login.php">Usuario</a></h6>
