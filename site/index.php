...
<div class="container">
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow-sm">
      ...
      <div class="card-body">
        <h1 class="card-title pricing-card-title">R$ 499,90 <small class="text-muted">/ mês</small></h1>
        <ul class="list-unstyled mt-3 mb-4">
          <li>Monitoramento de ganhos</li>
          <li>Mais de 500 vagas no servidor</li>
          <li>Suporte da empresa</li>
        </ul>
        <a href="contato.php"><button type="button" class="btn btn-lg btn-block btn-primary">Contate-nos</button></a>
      </div>
    </div>
    <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <div class="card-body">
        <h1 class="card-title pricing-card-title">R$ 249,90 <small class="text-muted">/ Mês</small></h1>
        <ul class="list-unstyled mt-3 mb-4">
