...
<br>
<br>
  <form class="form-signin" method="post" action="esqueceuservercatraca.php">
...
<h6> Insira o seu CPF que resolvemos isso.</h6><br>
    ...
    <button type="submit" class="btn btn-lg btn-primary btn-block" name="reg_p">Consultar</button>
  </form>
