...
<br>
<br>
  <form class="form-signin" method="post" action="pserver.php">

<img class="mb-4" src="img/icone.png" alt="" width="72" height="72"><br>
<h3> Confirmar Reservar </h3>
<label>Ao confirmar a reserva o usuário deverá chegar durante um periodo de <b>3 HORAS</b> se não sua vaga será liberada.</label>
